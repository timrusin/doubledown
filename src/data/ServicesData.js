const ServicesData = [
{
    ...
    subName: "Starting at $80",
    bulletOne:"- Thorough cleaning of wheels and tires.",
    bulletTwo:"- Foaming pre-wash.",
...
},
{
    ...
    bulletThree:"- Scratch Free Contact Wash. ",
    bulletFour:"- Mechanical Paint decontamination. ",
    bulletFive:"- Forced air and microfiber drying.",
...
},
{
    ...
    subName: "statring at $100",
    bulletOne:"- Trash removal and disposal.",
    bulletTwo:"- Thorough vacuuming of all carpeted services.",
...
},
{
    ...
    bulletOne:"- Trash removal and disposal.",
    bulletTwo:"- Thorough vacuuming of all carpeted services.",
    bulletThree:"- Shampooing of floor carpets. ",
    bulletFour:"- Shampooing of cloth seats.",
    bulletFive:"- Extreme odor removal when necessary. ",
